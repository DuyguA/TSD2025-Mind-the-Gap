...
pipeline = FlaxWhisperPipline("../do_train_segmented/whisper-puncted-segmented/90", dtype=jnp.bfloat16, batch_size=16)
...
text = pipeline(audio_input, stride_length_s=5, chunk_length_s=30, return_boundary=True, return_timestamps=True)
print(text)
