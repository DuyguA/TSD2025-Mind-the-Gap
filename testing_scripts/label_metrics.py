...
def calculate_label_stats(reference_tokens, hypothesis_tokens, reference_bio, hypothesis_bio):
  entity_mapping = defaultdict(list)
  entity_success_jw = {}
  entity_success_cer = {}

  entity_triplets = extract_entity_texts(reference_tokens, hypothesis_tokens, reference_bio, hypothesis_bio)
